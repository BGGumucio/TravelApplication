...
# now.strftime('%Y-%m-%d'),now.strftime('%Y-%m-%d'
    ...
    tourItemsUnicode = [startLocation,endLocation,startDate.strftime('%Y-%m-%d'),endDate.strftime('%Y-%m-%d'),price,description,50,name,region,tourImageLink,mapImageLink]
